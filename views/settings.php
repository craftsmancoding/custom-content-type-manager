...
$data->pagetitle = __('Global Settings', CCTM_TXTDOMAIN);
$data->help = 'https://code.google.com/p/wordpress-custom-content-type-manager/wiki/Settings';
...
<form id="custom_post_type_manager_settings" method="post">
	...
	<div class="cctm_element_wrapper" id="custom_field_wrapper_delete_posts">
        <input type="hidden" name="delete_posts" value="0" />
		<input type="checkbox" name="delete_posts" class="cctm_checkbox" id="delete_posts" value="1" <?php print self::is_checked($data->delete_posts); ?>/>
	...
	<div class="cctm_element_wrapper" id="custom_field_wrapper_delete_custom_fields">
        <input type="hidden" name="delete_custom_fields" value="0" />
		<input type="checkbox" name="delete_custom_fields" class="cctm_checkbox" id="delete_custom_fields" value="1" <?php print self::is_checked($data->delete_custom_fields); ?>/>
	...
	<div class="cctm_element_wrapper" id="custom_field_wrapper_save_empty_fields">
        <input type="hidden" name="save_empty_fields" value="0" />	
		<input type="checkbox" name="save_empty_fields" class="cctm_checkbox" id="save_empty_fields" value="1" <?php print self::is_checked($data->save_empty_fields); ?>/>
		...
		<span class="cctm_description"><?php _e("If checked, the CCTM will create a row in the postmeta table for each custom field, even if the field is empty.  This can make some kinds of reporting queries easier, but it does take more room in your database. Uncheck this if you need to save some space in your database.", CCTM_TXTDOMAIN); ?></span>
	</div>

	<h2><?php _e('Menus', CCTM_TXTDOMAIN); ?></h2>
	<!--!Custom Fields Menu -->
	<div class="cctm_element_wrapper" id="custom_field_wrapper_show_custom_fields_menu">
        <input type="hidden" name="show_custom_fields_menu" value="0" />	
		<input type="checkbox" name="show_custom_fields_menu" class="cctm_checkbox" id="show_custom_fields_menu" value="1" <?php print self::is_checked($data->show_custom_fields_menu); ?>/>
	...
	<div class="cctm_element_wrapper" id="custom_field_wrapper_show_settings_menu">
        <input type="hidden" name="show_settings_menu" value="0" />	
		<input type="checkbox" name="show_settings_menu" class="cctm_checkbox" id="show_settings_menu" value="1" <?php print self::is_checked($data->show_settings_menu); ?>/>
	...
	<div class="cctm_element_wrapper" id="custom_field_wrapper_hide_posts">
        <input type="hidden" name="hide_posts" value="0" />	
		<input type="checkbox" name="hide_posts" class="cctm_checkbox" id="hide_posts" value="1" <?php print self::is_checked($data->hide_posts); ?>/>
	...
	<div class="cctm_element_wrapper" id="custom_field_wrapper_hide_pages">
        <input type="hidden" name="hide_pages" value="0" />	
		<input type="checkbox" name="hide_pages" class="cctm_checkbox" id="hide_pages" value="1" <?php print self::is_checked($data->hide_pages); ?>/>
	...
	<div class="cctm_element_wrapper" id="custom_field_wrapper_hide_links">
        <input type="hidden" name="hide_links" value="0" />
		<input type="checkbox" name="hide_links" class="cctm_checkbox" id="hide_links" value="1" <?php print self::is_checked($data->hide_links); ?>/>
	...
	<div class="cctm_element_wrapper" id="custom_field_wrapper_hide_comments">
        <input type="hidden" name="hide_comments" value="0" />	
		<input type="checkbox" name="hide_comments" class="cctm_checkbox" id="hide_comments" value="1" <?php print self::is_checked($data->hide_comments); ?>/>
	...
	<div class="cctm_element_wrapper" id="custom_field_wrapper_show_foreign_post_types">
        <input type="hidden" name="show_foreign_post_types" value="0" />	
		<input type="checkbox" name="show_foreign_post_types" class="cctm_checkbox" id="show_foreign_post_types" value="1" <?php print self::is_checked($data->show_foreign_post_types); ?>/>
	...
	<div class="cctm_element_wrapper" id="custom_field_wrapper_summarizeposts_tinymce">
        <input type="hidden" name="summarizeposts_tinymce" value="0" />	
		<input type="checkbox" name="summarizeposts_tinymce" class="cctm_checkbox" id="summarizeposts_tinymce" value="1" <?php print self::is_checked($data->summarizeposts_tinymce); ?>/>
	...
	<div class="cctm_element_wrapper" id="custom_field_wrapper_summarizeposts_tinymce">
        <input type="hidden" name="custom_fields_tinymce" value="0" />	
		<input type="checkbox" name="custom_fields_tinymce" class="cctm_checkbox" id="custom_fields_tinymce" value="1" <?php print self::is_checked($data->custom_fields_tinymce); ?>/>
	...
	<div class="cctm_element_wrapper" id="custom_field_wrapper_enable_right_now">
        <input type="hidden" name="enable_right_now" value="0" />	
		<input type="checkbox" name="enable_right_now" class="cctm_checkbox" id="enable_right_now" value="1" <?php print self::is_checked($data->enable_right_now); ?>/>
	...
	<div class="cctm_element_wrapper" id="custom_field_wrapper_pages_in_rss_feed">
        <input type="hidden" name="pages_in_rss_feed" value="0" />	
		<input type="checkbox" name="pages_in_rss_feed" class="cctm_checkbox" id="pages_in_rss_feed" value="1" <?php print self::is_checked($data->pages_in_rss_feed); ?>/>
	...
	<div class="cctm_element_wrapper" id="custom_field_wrapper_cache_thumbnail_images">
        <input type="hidden" name="cache_thumbnail_images" value="0" />	
		<input type="checkbox" name="cache_thumbnail_images" class="cctm_checkbox" id="cache_thumbnail_images" value="1" <?php print self::is_checked($data->cache_thumbnail_images); ?>/>
...
<?php print $data->noncefield; ?>
	<?php //wp_nonce_field($data['action_name'], $data['nonce_name']); ?>
	<br/>
	<div class="custom_content_type_mgr_form_controls">
		<input type="submit" name="Submit" class="button-primary" value="<?php _e('Update Settings', CCTM_TXTDOMAIN); ?>" />
	</div>
</form>
